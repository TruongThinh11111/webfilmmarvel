    ...
    className=" mx-auto max-w-full" width="960px" height="540px" />
      ...
      <div className='group grid grid-cols-4 gap-4 md:gap-8 mt-8 max-w-3xl mx-auto'>
        ...
        <div key={trailer.image} className='relative group-hover:not-hover:opacity-50 hover:translate-y-1 duration-300 transition max-md:h-60 md:max-h-60 cursor-pointer' onClick={()=> setCurrentTrailer(trailer)}>
          ...
          <img src={trailer.image} alt="trailer" className='rounded-lg w-full h-full object-cover cursor-pointer'/>
          <PlayIcon strokeWidth={1.6} className='absolute top-1/2 left-1/2 w-5 md:w-8 h-5 md:h-12 transform -translate-x-1/2 -translate-y-1/2' />
          </div>  
          ))}
