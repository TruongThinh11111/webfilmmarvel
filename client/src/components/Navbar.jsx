...
font-medium max-md:text-lg z-50 flex flex-col 
...
duration-300 ${isOpen ? 'max-md:w-full' : 'max-md:w-0 max-md:opacity-0'}`}>

        
        <XIcon className='md:hidden absolute top-6 right-6 w-6 h-6 cursor-pointer' onClick={() => setIsOpen(false)} />

      <Link onClick={()=> {window.scrollTo(0,0);setIsOpen(false);}} to='/home'>Home</Link>
